            ...
            <div class="card-body">
                ...
                <table class="table" id="agents">
                    ...
                    <tbody>
                        @if ($expenses->isEmpty())
                            <tr>
                                <td colspan="5" class="text-center text-danger">No Expenses Entries Added Yet</td>
                            </tr>
                        @else
                                ...
                                <tr>
                                    ...
                                    <td style=" display:flex; justify-content:center;align-items-center">
                                        <a href="#" class="text-info mr-3 edit_agent"
                                            data-expense-id="{{ $expense->id }}" data-toggle="modal"
                ...
                <div class="modal-body">
                    <form id="agentForm" method="post" action="">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary btn-sm" id="saveButton">Add Expenses</button>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Success',
                            text: 'Expenses ' + (method == 'POST' ? 'added' :
                                    'updated') +
                                ' successfully',
                        }).then((result) => {
                            location.reload();
